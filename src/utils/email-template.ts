...
export function generateResetPasswordEmailTemplate(firstName: string, link: string): string {
  return `<!DOCTYPE html>
          ...
          <body style="font-family: Arial, sans-serif; background-color:#f5f7fa; margin:0; padding:0;">
            <table align="center" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
              <tr>
                <td style="padding:20px; text-align:center; background:#1f2937; color:#ffffff;">
              ...
              <tr>
                <td style="padding:30px; color:#333333;">
                  ...
                  <p style="text-align:center; margin:30px 0;">
                    <a href="${link}" style="background:#1f2937; color:#ffffff; padding:12px 24px; text-decoration:none; border-radius:6px; font-weight:bold;">Reset Password</a>
                  </p>
              ...
              <tr>
                <td style="padding:20px; text-align:center; background:#f3f4f6; color:#666666; font-size:12px;">
                  <p style="margin:0;">© 2025 PrepWise. All rights reserved.</p>
                </td>
              </tr>
            </table>
          </body>
